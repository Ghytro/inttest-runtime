...
func (Py Py) newGoFunction_Type() (TypeObject, error) {
	...
	defer Py.DecRef(t.Object())
	if t.t == nil {
		return TypeObject{}, Py.GoCatchError()
	}
	if C.setTypeHandle(t.t, unsafe.Pointer(Py.state)) < 0 {
		return TypeObject{}, fmt.Errorf("cannot set GoFunction type handle")
	}
	c := GoConvConf{
		TypeObject: t,
...
func funcToObject(Py Py, a interface{}) (Object, error) {
	...
	err = fn.GoAttrs.PySetAttr(Py, "__class__", Py.GoFunction_Type().Object())
	if err != nil {
		return Object{}, err
	}
...
func funcFromObject(Py Py, o Object, a interface{}) error {
	...
	case reflect.Func:
		if dest.Elem().Type() != fn.Type() {
			return fmt.Errorf("cannot convert Python <%s> to Go <%s>", fn.Type(), dest.Elem().Type())
		}
	default:
		return Py.GoErrorConvFromObject(o, a)
	}
